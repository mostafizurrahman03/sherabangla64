        ...
        <div class="card card-primary">
          ...
          <form action="{{ route('header.update', $header->id ?? 1) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="image">Header Image<span class="text-danger">*</span> <small>(png image)</small></label>
                ...
                <div class="mt-3">
                  <img src="{{ asset($header->image) }}" alt="Header Image" width="120" class="img-thumbnail rounded">
                </div>
                @endif
              </div>
            </div>
